import CSVCatalog
import CSVTable_Template

import time
import json

#data_dir = "../Data/core/"
data_dir = "/Users/irene/"
...
def test_join_not_optimized(optimize=False):
    ...
    people_tbl = CSVTable_Template.CSVTable("people")
    batting_tbl = CSVTable_Template.CSVTable("batting")
...
def test_join_optimizable_2(optimize=False):
    ...
    join_result = people_tbl.join(batting_tbl,['playerID'], None, None, optimize=optimize)
